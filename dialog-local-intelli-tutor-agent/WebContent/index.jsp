...
<body>
	...
	<div class="_demo--container">
		<a class="wordmark" href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/">
			<span class="wordmark--left">IBM Watson</span>
			<span class="wordmark--right">Intelli Tutoring Agent</span>
		</a>
	...
	<div class="_demo--container">
		...
		<div class="banner--service-info">
			<h1 class="banner--service-title base--h1">
				...
				Intelli Tutoring Agent
			</h1>
			<div class="banner--service-description">This is an intelligent tutoring app using IBM's watson dialog service.
			 This can help understanding difficult concepts by representing knowledge in a simple form. This will demonstrate Newton's Law,Period Table and Geometry with some detail to a kid.</div>
			
			<div class="banner--service-description">Using Watson's Dialog service - 
			The Dialog service provides a comprehensive, technology platform for managing conversations between virtual agents and users through an Application Programming Interface (API).</div>
	...
	<article class="_demo--content base--article">
		<!-- <h2 class="base--h2">
			Choose a Subject to start the dialog
		</h2>
		...
		<div class="radio-group">
			...
			<label for="hello-radio" class="base--label radio-group--label">Maths</label>
			<input type="radio" name="dialog-template" id="yellow-radio" value="yellow" class="base--radio">
			<label for="yellow-radio" class="base--label radio-group--label">Physics</label>
			<input type="radio" name="dialog-template" id="green-radio" value="green" class="base--radio">
			<label for="green-radio" class="base--label radio-group--label">Chemistry</label>
		</div> -->
						...
						<div class="chat-box--item_WATSON chat-box--item chat-box--item_HIDDEN">
							<div class="chat-box--container">
								<div class="img-container chat-box--avatar chat-box--avatar_WATSON">
									<img src="images/icons/watson.jpeg" class="chat-box--avatar-img">
								</div>
